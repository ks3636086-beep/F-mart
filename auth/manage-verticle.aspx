<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" CodeFile="manage-verticle.aspx.cs" Inherits="auth_manage_verticle" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapsetwo" style="text-decoration: none">Manage Verticle</a>
                    </h4>
                </div>
                                    ...
                                    <tbody id="tlist" runat="server">
                                        ...
                                        <asp:Repeater ID="rptbinddata" runat="server" OnItemCommand="rptbinddata_ItemCommand" OnItemDataBound="rptbinddata_ItemDataBound">
                                            <ItemTemplate>
                                                 ...
                                                 <asp:Label ID="lbl_sub_category_id" hidden runat="server" Text='<%# Eval("sub_category_id") %>'></asp:Label>
                                                ...
                                                <tr>
                                                   <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbl_category_name" runat="server" Text=""></asp:Label>
                                                    </td>
                                                    <td>
                                                        <%# Eval("verticle_status") %>
                                                    </td>

                                                    <td>
                                                        <a class="link-success" href="edit-verticle.aspx?ref=<%#  Eval("id") %>" target="_blank" title="Edit"><i class="fa fa-edit"></i></a>
                                                        <a class="link-primary" href="#" data-toggle="modal" data-target="#Enable<%#  Eval("id") %>" title="Publish"><i class="fa fa-check"></i></a>
                                                        <a class="link-primary" href="#" data-toggle="modal" data-target="#disable<%#  Eval("id") %>" title="Unpublish"><i class="fa fa-ban"></i></a>
