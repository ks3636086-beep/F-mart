<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" CodeFile="betweeb-banner.aspx.cs" Inherits="auth_slider" %>
    ...
    <div id="accordion-container">
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration: none">In Between Banner
                        </a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            <br />
                             ...
                             <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="dbl_option" AppendDataBoundItems="True" class="form-control" runat="server">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Choose photo (500px Width X 263px Height)<span style="color: red">&nbsp;*</span></label>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2" style="text-decoration: none">Manage Banner 
                        </a>
                    </h4>
                </div>
                                            ...
                                            <asp:Repeater ID="rptbinddata" runat="server" OnItemCommand="rptbinddata_ItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src='<%# Eval("photo_path") %>' style="height: 50px; width: auto" />
                                                        </td>
