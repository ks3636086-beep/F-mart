...
public partial class auth_cancelled_restaurant_orders : System.Web.UI.Page
{
    ...
    {
        this.rptbindorderdata.DataSource = GetData("SELECT * FROM ecommerce_order where order_status='Cancelled' AND order_section='Restaurant' order by id desc");
