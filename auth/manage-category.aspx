...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <b>Publish Category if you want to display on website</b>
    &nbsp;&nbsp;<br />
    <br />
    <label class="btn btn-primary"><i class="fa fa-ban"></i></label>
    <b>Unpublish Category if you don't want to display on website</b>
    &nbsp;&nbsp;
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="link-info" href="manage-sub-category.aspx?ref=<%# Eval("category_id") %>"  title="Sub Category"><i class="fa fa-eye"></i></a>
                                                        <a class="link-success" href="edit-category.aspx?ref=<%#  Eval("category_id") %>"  title="Edit"><i class="fa fa-edit"></i></a>
