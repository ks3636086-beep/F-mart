<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" CodeFile="offer-banner.aspx.cs" Inherits="auth_slider" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration: none">Offer Banner
                        </a>
                    </h4>
                </div>
                                            ...
                                            <asp:Repeater ID="rptbinddata" runat="server" OnItemCommand="rptbinddata_ItemCommand">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src='<%# Eval("banner_path") %>' style="height: 50px; width: auto" />
                                                        </td>
