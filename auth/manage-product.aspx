<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="manage-product.aspx.cs" Inherits="auth_manage_product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblproductid" hidden runat="server" Text=""></asp:Label>
      ...
      <br />
    <a href="add-product" class="btn btn-success" runat="server"><i class="fa fa-plus"></i>&nbsp;Add Product</a>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" hidden class="link-success" ID="lnk_duplicate" title="Product Duplicate" CommandArgument='<%# Eval("product_id") %>' OnClick="lnk_duplicate_Click"><i class="fas fa-copy"></i></asp:LinkButton>
