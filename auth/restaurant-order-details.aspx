<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" CodeFile="restaurant-order-details.aspx.cs" Inherits="auth_order_details" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="alert" id="alert_container"></div>
      <br />
    <a href="all-restaurant-orders" class="btn btn-success" runat="server"><i class="fa fa-list"></i>&nbsp;Back To Order List</a>
