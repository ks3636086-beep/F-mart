<%@ Page Title="" Language="C#" MasterPageFile="~/auth/admin.master" AutoEventWireup="true" CodeFile="manage-pincode.aspx.cs" Inherits="auth_manage_pincode" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration: none">Add Pincode
                        </a>
                    </h4>
                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="dblstate" AutoPostBack="true" AppendDataBoundItems="True" class="form-control" data-live-search="true" runat="server" OnSelectedIndexChanged="dblstate_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="body-box table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody id="tlist" runat="server">
                                        ...
                                        <asp:Repeater ID="rptbindpincodedata" runat="server" OnItemCommand="rptbindpincodedata_ItemCommand">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="link-success" href="edit-pincode-area.aspx?ref=<%#  Eval("id") %>" title="Edit"><i class="fa fa-edit"></i></a>
