<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="account.aspx.cs"
    Inherits="account" %>
                            ...
                            <div class="tab-content">
                                                ...
                                                <div class="order-card" data-aos="fade-up" data-aos-delay="100">
                                                    ...
                                                    <div class="order-content">
                                                        ...
                                                        <div class="order-info">
                                                            ...
                                                            <div class="info-row">
                                                                <span>Items</span>
                                                                <span>
                                                                    <%# Eval("total_item") %> items
                                                                </span>
                                                            </div>
                                                            <div class="info-row">
                                                                <span>Total</span>
                                                                <span class="price">Rs. <%# Eval("total_order_amount")
                                                                        %></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="order-footer">
                                                        <button type="button" class="btn-track"
                                                            data-bs-toggle="collapse" data-bs-target="#tracking1"
                                                            aria-expanded="false">Track Order</button>
                                                        <button type="button" class="btn-details"
                                                            data-bs-toggle="collapse" data-bs-target="#details1"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div class="wishlist-card" data-aos="fade-up" data-aos-delay="100">
                                                    <div class="wishlist-image">
                                                        <img src='auth/<%# Eval("photo_path") %>' alt="Product"
                                                            loading="lazy">
                                ...
                                <div class="tab-pane fade" id="addresses">
                                    <div class="section-header" data-aos="fade-up">
                                        <h2>My Address</h2>
                                        <div class="header-actions">
                                            <button type="button" class="btn btn-primary btn-submit" id="btnaddress"
                                                runat="server" onserverclick="btnaddress_ServerClick">
                                    ...
                                    <div class="addresses-grid">
                                        ...
                                        <asp:Repeater ID="Repeater2" runat="server"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <!-- Address Card 1 -->
                                                <div class="address-card default" data-aos="fade-up"
                                                    data-aos-delay="100">
                                                    ...
                                                    <p class="address-text">
                                                        <%# Eval("address_line_1") %>,
                                                            <%# Eval("address_line_2") %><br>
                                                                <%# Eval("address_city_name") %>, <%#
                                                                        Eval("address_state_name") %> - <%#
                                                                            Eval("address_pincode") %>
                                                    </p>
                                                    <div class="contact-info">
                                                        <div><i class="bi bi-person"></i>
                                                            <%# Eval("address_customer_name") %>
                                                        </div>
                                ...
                                <div class="settings-content">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <asp:TextBox runat="server" type="text" class="form-control"
                                                        id="name" required=""></asp:TextBox>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="email" class="form-label">Email</label>
                                                    <asp:TextBox runat="server" type="text" class="form-control"
                                                        id="email" required=""></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="phone" class="form-label">Mobile No.</label>
                                                    <asp:TextBox runat="server" type="text" class="form-control"
                                                        id="phone"></asp:TextBox>
                                                </div>
                                            </div>

                                            <div class="form-buttons">
                                                <button type="submit" id="btnprofileupdate" runat="server"
                                                    onserverclick="btnprofileupdate_ServerClick" class="btn-save">Save
                                                    Changes</button>
                                            </div>
                                    ...
                                    <div class="settings-section" data-aos="fade-up" data-aos-delay="200">
                                        ...
                                        <div class="php-email-form settings-form">
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    <label for="currentPassword" class="form-label">Current
                                                        Password</label>
                                                    <asp:TextBox runat="server" type="password" class="form-control"
                                                        id="currentPassword" required=""></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="newPassword" class="form-label">New Password</label>
                                                    <asp:TextBox runat="server" type="password" class="form-control"
                                                        id="newPassword" required=""></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-buttons">
                                                <button type="submit" id="btnupdatepassword" runat="server"
                                                    onserverclick="btnupdatepassword_ServerClick"
                                                    class="btn-save">Update Password</button>
                                            </div>
                                    ...
                                    <div class="settings-section danger-zone" data-aos="fade-up" data-aos-delay="300">
                                        ...
                                        <div class="danger-zone-content">
                                            ...
                                            <button type="button" class="btn-danger" id="btndelete" runat="server"
                                                onserverclick="btndelete_ServerClick">Delete Account</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
